  ...
  return (
    <>
        <div className=' h-[600px] md:w-full  bg-beige-400 color-black  pt-14 'ref={ref}>
            ...
            <h1 className='text-4xl font-semibold  m-2 sm:m-10'>Phone Number: <span className='font-bold'>8057839525</span></h1>
            <h1 className='text-4xl  font-semibold m-2 sm:m-10'>Email:<span className='font-bold'>5V9gW@example.com</span> </h1>
